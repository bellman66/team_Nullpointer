...
public class ArtistServiceImple implements ArtistService {
	...
	public List<Artist> todayList() {
		...
		/*
		 * class Inner { private Artist artist;
		 * 
		 * public Inner(Artist artist) { this.artist = artist; }
		 * 
		 * public Artist getArtist() { return artist; }
		 * 
		 * @Override public boolean equals(Object obj) { Inner other = (Inner) obj; if
		 * (artist.getM_id() == null) { if (other.getArtist().getM_id() != null) return
		 * false; } return true; }
		 * 
	 ...
	 * @date : 2020. 6. 14.
	 * @buildBy : 박혜연
	 * @comment : 아티스트 회원의 마이페이지 내에서 본인이 올린 업로드 목록 노출
	 */
	@Override
