				...
				<div class="row">
					<div class="board">
						<div id="boardTab">
							<!--탭 메뉴 영역 -->
							<ul class="tabs">
								<li id="prtab"><a href="#tab1" onclick="prSubmit()">홍보
										게시판</a></li>
								<li id="shtab"><a href="#tab2" onclick="shSubmit()">공유
										게시판</a></li>
							</ul>
							...
							<div class="tab_container" style="height: 420px;">
								...
								<div id="tab1" class="tab_content">
									<form name="pr"
										action="<%=request.getContextPath()%>/board/boardPR.do"
										onsubmit="submit()">
											...
											<tbody>
												<c:forEach items="${boardList.nlist}" var="board">
													...
													<tr>
														...
														<td class="prTitle"><a
															href="<%= request.getContextPath() %>/board/boardRead.do?b_num=${board.b_num}">${board.b_title}</a></td>
											...
											<ul class="bdpaging">
												...
												<c:if test="${board  eq 'searchPR'}">
													...
													<c:choose>
														...
														<c:otherwise>
															<a
																href="<%= request.getContextPath() %>/board/boardSearchPR.do&searchType=${searchType}&searchWord=${searchWord}"
																class="nav prev" style="background-color: white">
																&lt;</a>
														</c:otherwise>
													</c:choose>
													...
													<c:choose>
														<c:when test="${paging.currentPage+1 > paging.lastPage }">
															<a
																href="<%= request.getContextPath() %>/board/boardSearchPR.do?cPage=${paging.blockEnd}&searchType=${searchType}&searchWord=${searchWord}"
																class="nav next" style="background-color: white">
																&gt;</a>
														</c:when>
													...
													<a
														href="<%= request.getContextPath() %>/board/boardSearchPR.do?cPage=${paging.lastPage}&searchType=${searchType}&searchWord=${searchWord}"
														class="nav last" style="background-color: white">&gt;&gt;</a>
												</c:if>
											</ul>
										</div>
								...
								<div id="tab2" class="tab_content">
									<form name="sh"
										action="<%=request.getContextPath()%>/board/boardSH.do"
										onsubmit="submit()">
										<table class="bd-Table">
											<colgroup>
												<!-- 넓이 지정  -->
										...
										<div class="bdpage" id="bdpage">
											...
											<ul class="bdpaging">
												<c:if test="${board  eq 'sh'}">
													<a href="<%=request.getContextPath()%>/board/boardSH.do"
														class="nav first" style="background-color: white">&lt;&lt;</a>
													<c:choose>
														<c:when test="${paging.currentPage > 1 }">
															<a
																href="<%= request.getContextPath() %>/board/boardSH.do?cPage=${paging.currentPage-1}"
																class="nav prev" style="background-color: white">
																&lt;</a>
														</c:when>
														<c:otherwise>
															<a
																href="<%= request.getContextPath() %>/board/boardSH.do?cPage=${paging.blockStart}"
																class="nav prev" style="background-color: white">
																&lt;</a>
														</c:otherwise>
													</c:choose>
													...
													<c:forEach begin="${paging.blockStart}"
														...
														<a
															href="<%= request.getContextPath() %>/board/boardSH.do?cPage=${page}"
															class="num active"><span>${page}</span></a>
													</c:forEach>
													...
													<c:choose>
														<c:when test="${paging.currentPage+1 > paging.lastPage }">
															<a
																href="<%= request.getContextPath() %>/board/boardSH.do?cPage=${paging.blockEnd}"
																class="nav next" style="background-color: white">
																&gt;</a>
														</c:when>
													...
													<a
														href="<%= request.getContextPath() %>/board/boardSH.do?cPage=${paging.lastPage}"
														class="nav last" style="background-color: white">&gt;&gt;</a>
												</c:if>
												...
												<c:if test="${board  eq 'searchSH'}">
													<a
														href="<%= request.getContextPath() %>/board/boardSearchSH.do?board=${board}&searchType=${searchType}&searchWord=${searchWord}"
														class="nav first" style="background-color: white">&lt;&lt;</a>
													<c:choose>
														<c:when test="${paging.currentPage > 1 }">
															<a
																href="<%= request.getContextPath() %>/board/boardSearchSH.do?cPage=${paging.currentPage-1}&searchType=${searchType}&searchWord=${searchWord}"
																class="nav prev" style="background-color: white">
																&lt;</a>
														</c:when>
														<c:otherwise>
															<a
																href="<%= request.getContextPath() %>/board/boardSearchSH.do?&searchType=${searchType}&searchWord=${searchWord}"
																class="nav prev" style="background-color: white">
																&lt;</a>
														</c:otherwise>
													</c:choose>
													...
													<c:forEach begin="${paging.blockStart}"
														...
														<a
															href="<%= request.getContextPath() %>/board/boardSearchSH.do?cPage=${page}&board=${board}&searchType=${searchType}&searchWord=${searchWord}"
															class="num active"><span>${page}</span></a>
													</c:forEach>
													...
													<c:choose>
														<c:when test="${paging.currentPage+1 > paging.lastPage }">
															<a
																href="<%= request.getContextPath() %>/board/boardSearchSH.do?cPage=${paging.blockEnd}&searchType=${searchType}&searchWord=${searchWord}"
																class="nav next" style="background-color: white">
																&gt;</a>
														</c:when>
													...
													<a
														href="<%= request.getContextPath() %>/board/boardSearchSH.do?cPage=${paging.lastPage}&searchType=${searchType}&searchWord=${searchWord}"
														class="nav last" style="background-color: white">&gt;&gt;</a>
												</c:if>
											</ul>
								...
								<div class="bdsearch">
									<c:if test="${board  eq 'sh' || board eq 'searchSH'}">
										<form
											action="<%=request.getContextPath()%>/board/boardSearchSH.do?board=${board}"
											method="post">
									</c:if>
